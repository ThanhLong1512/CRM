      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 rounded-2xl border border-slate-200/90 bg-white p-5 shadow-xs">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-3">
            <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-500/10 text-amber-600 border border-amber-500/20 shadow-xs">
              <BarChart3 className="size-5" aria-hidden />
            </div>
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="font-display text-lg sm:text-xl md:text-2xl font-black tracking-tight text-slate-900">
                  Bảng Chỉ Huy Giám Đốc Kinh Doanh
                </h2>
                <span className="hidden sm:inline text-xs font-semibold text-slate-400">
                  (Executive Dashboard)
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-900 px-2.5 py-0.5 font-mono text-[11px] font-bold text-amber-400 shadow-xs">
        ...
        <div className="flex shrink-0 items-center gap-2.5 flex-wrap sm:flex-nowrap">
          <Link
            href="/sales"
            className="flex h-9 items-center gap-1.5 rounded-xl bg-amber-500 px-3.5 text-xs font-bold text-slate-950 shadow-xs shadow-amber-500/20 border border-amber-600/30 transition-all hover:bg-amber-400 active:scale-95"
          >
          ...
          <Link
            href="/don-hang"
            className="flex h-9 items-center gap-1.5 rounded-xl bg-slate-900 px-3.5 text-xs font-semibold text-white shadow-xs border border-slate-800 transition-all hover:bg-slate-800 active:scale-95"
          >
            <Layers className="size-4 text-amber-400 shrink-0" aria-hidden />
